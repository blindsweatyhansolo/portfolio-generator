...
const generateProjects = projectsArr => {
    ...
    // // create new array with data from projectsArr
...
module.exports = templateData => {
    ...
    // projects and about variables created, but the rest of the data is held in
    // the header object by using rest operator [...]
